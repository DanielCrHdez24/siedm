...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["buscar"])) {
    ...
    $sql = "SELECT id_paciente, nombre, curp, fecha_nacimiento FROM pacientes 
            WHERE id LIKE ? OR nombre LIKE ? OR curp LIKE ?";
        ...
        <tbody>
            <?php while ($fila = $resultados->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
                        <a href="modificar_paciente.php?id=<?php echo $fila['id']; ?>" class="btn-modificar">
                            <i class="fas fa-edit"></i> Modificar
                        </a>
                        <a href="eliminar_paciente.php?id=<?php echo $fila['id']; ?>" class="btn-eliminar" onclick="return confirm('¿Estás seguro de eliminar este paciente?');">
