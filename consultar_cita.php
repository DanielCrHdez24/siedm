...
<body class="principal">
    <div class="wrapper">
        ...
        <div class="container">
            <h2>Consultar Cita Médica</h2>

            <form class="form" action="consultar_cita_backend.php" method="POST">
                ...
                <label for="fecha_cita">Buscar citas a partir de:</label>
                <input type="date" id="fecha_cita" name="fecha_cita_inicio">
                <p></p>
